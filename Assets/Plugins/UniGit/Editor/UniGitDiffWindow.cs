...
public class UniGitDiffWindow : EditorWindow {
    ...
    private void RenderWindow(GitFileStatus fileStatus) {
        ...
        var exec = UniGit.ExecuteProcessTerminal2($"diff --word-diff=porcelain -U9999 {fileStatus.path}", "git");
        ...
        //  git diff --word-diff=porcelain -U$(wc -l Assets/Plugins/UniGit/Editor/UniGitPostprocessor.cs)
